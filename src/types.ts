...
export interface SiteTexts {
  ...
  logoSubFontSizeMobile?: string;
  menuFontSizeDesktop?: string;
  ...
  helplineCentralLabelNe?: string;
  helplinePhone?: string;
  helplineSecretariatLabelEn?: string;
  helplineSecretariatLabelNe?: string;
  helplineEmail?: string;
  pillarsTitleEn?: string;
  pillarsTitleNe?: string;
  pillar1TitleEn?: string;
  pillar1TitleNe?: string;
  pillar1SubEn?: string;
  pillar1SubNe?: string;
  pillar2TitleEn?: string;
  pillar2TitleNe?: string;
  pillar2SubEn?: string;
  pillar2SubNe?: string;
  pillar3TitleEn?: string;
  pillar3TitleNe?: string;
  pillar3SubEn?: string;
  pillar3SubNe?: string;
  pillar4TitleEn?: string;
  pillar4TitleNe?: string;
  pillar4SubEn?: string;
  pillar4SubNe?: string;
